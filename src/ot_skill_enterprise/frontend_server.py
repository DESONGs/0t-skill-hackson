...
def build_overview_payload(workspace_dir: Path | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "commands": [
            "0t runtime list",
            "0t runtime overview",
            "0t runtime start --runtime pi",
            "0t runtime run --runtime pi --prompt 'inspect repository'",
            "0t runtime sessions",
            "0t runtime active-runs",
            "0t runtime record-run --payload-file <run.json>",
            "0t candidate list",
            "0t candidate compile --payload-file <candidate.json>",
            "0t candidate validate --candidate-id <id>",
            "0t candidate promote --candidate-id <id>",
            "0t style list",
            "0t style distill --wallet 0xabc --chain solana",
            "0t style get --job-id <job_id>",
            "0t style resume --job-id <job_id>",
        ],
        "runtime_context": {
